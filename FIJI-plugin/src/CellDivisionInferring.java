 ...
 * </p>
 */
@Plugin(type = Command.class, menuPath = "Plugins>CellDivisionInferring")
public class CellDivisionInferring<T extends RealType<T>> implements Command {
    //
    ...
    public static void main(final String... args) throws Exception {
        ...
        if (file != null) {
            ...
            // invoke the plugin
            ij.command().run(CellDivisionInferring.class, true);
        }
    }
